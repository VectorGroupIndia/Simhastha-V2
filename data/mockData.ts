...
export const mockReports: Report[] = [
    ...
    { id: 'rep-p1', reporterId: 'u8', reportCategory: 'person', type: 'lost', item: 'Mahesh Kumar', description: 'Elderly man, wearing a white kurta and dhoti. He is about 5\'6" and has a walking stick. He might be disoriented.', date: '2024-07-23', status: 'in_review', location: 'Ram Ghat area', coords: { lat: 23.1815, lng: 75.7685 }, imageUrl: 'https://images.unsplash.com/photo-1582233479533-2a9f6a42a420?q=80&w=400', age: 72, gender: 'Male' },
    { id: 'rep-p2', reporterId: 'u9', reportCategory: 'person', type: 'lost', item: 'Priya', description: 'Young girl, wearing a bright yellow frock and has two ponytails. She was holding a small doll.', date: '2024-07-25', status: 'pending', location: 'Near Mahakaleshwar Temple entrance', coords: { lat: 23.1865, lng: 75.7665 }, imageUrl: 'https://images.unsplash.com/photo-1519241345512-a63dd2134516?q=80&w=400', age: 6, gender: 'Female' },
    
    // --- Lost & Found Item Reports ---
    { id: 'rep1', reporterId: 'u1', reportCategory: 'item', type: 'lost', item: 'iPhone 14 Pro', description: 'Black iPhone 14 Pro with a small crack on the top left corner. Has a blue Spigen case.', date: '2024-07-25', status: 'in_review', location: 'Ram Ghat, Ujjain', coords: { lat: 23.1818, lng: 75.7688 }, imageUrl: 'https://images.unsplash.com/photo-1677353952934-6e53f47c3e58?q=80&w=400', matches: ['rep2'] },
    { id: 'rep2', reporterId: 'u4', reportCategory: 'item', type: 'found', item: 'Apple iPhone', description: 'Found a black iPhone near the river. It has a cracked screen and a blue case. It is locked. Handed over to Help Desk 2.', date: '2024-07-25', status: 'pending', location: 'Ram Ghat, Ujjain', coords: { lat: 23.1816, lng: 75.7686 }, imageUrl: 'https://images.unsplash.com/photo-1677353952934-6e53f47c3e58?q=80&w=400', matches: ['rep1'] },
    { id: 'rep3', reporterId: 'u7', reportCategory: 'item', type: 'lost', item: 'Child\'s Blue Backpack', description: 'Small blue backpack with a Spider-Man keychain. Contains a water bottle and a lunchbox.', date: '2024-07-24', status: 'resolved', resolvedDate: '2024-07-25', location: 'Mahakaleshwar Temple', coords: { lat: 23.1860, lng: 75.7660 }, imageUrl: 'https://images.unsplash.com/photo-1553062407-98e365097524?q=80&w=400' },
    { id: 'rep4', reporterId: 'u6', reportCategory: 'item', type: 'found', item: 'Leather Wallet', description: 'Brown leather wallet containing some cash and an ID card for Suresh Kumar.', date: '2024-07-24', status: 'resolved', resolvedDate: '2024-07-25', location: 'Food court area', coords: { lat: 23.1765, lng: 75.7885 }, imageUrl: 'https://images.unsplash.com/photo-1613093902319-5b7541b4a370?q=80&w=400' },
    { id: 'rep5', reporterId: 'u5', reportCategory: 'item', type: 'lost', item: 'Silver Watch', description: 'Titan silver watch with a metal strap. Has a small scratch on the glass.', date: '2024-07-23', status: 'closed', location: 'Harsiddhi Temple', coords: { lat: 23.1837, lng: 75.7661 }, imageUrl: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?q=80&w=400' },
    { id: 'rep6', reporterId: 'u10', reportCategory: 'item', type: 'found', item: 'Set of Keys', description: 'A bunch of keys with a red Maruti car key and a few house keys.', date: '2024-07-23', status: 'in_review', location: 'Parking Lot B', coords: { lat: 23.1750, lng: 75.7850 }, imageUrl: 'https://images.unsplash.com/photo-1564282864384-35c2763d333b?q=80&w=400' },
    { id: 'rep7', reporterId: 'u1', reportCategory: 'item', type: 'lost', item: 'Black DSLR Camera', description: 'Nikon D5600 camera in a black bag with one extra lens.', date: '2024-07-22', status: 'pending', location: 'Near Shipra River bridge', coords: { lat: 23.1800, lng: 75.7720 }, imageUrl: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=400' },
    { id: 'rep8', reporterId: 'u4', reportCategory: 'item', type: 'found', item: 'Prescription Glasses', description: 'Black framed prescription glasses in a blue case.', date: '2024-07-22', status: 'pending', location: 'Help Desk 3', coords: { lat: 23.1830, lng: 75.7650 }, imageUrl: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?q=80&w=400' },
    { id: 'rep9', reporterId: 'u5', reportCategory: 'item', type: 'lost', item: 'Red Scarf', description: 'A plain red woolen scarf.', date: '2024-07-15', status: 'closed', location: 'Ujjain Railway Station', coords: { lat: 23.1754, lng: 75.7733 }, imageUrl: 'https://images.unsplash.com/photo-1600361099105-779c45038f32?q=80&w=400' },
    { id: 'rep10', reporterId: 'u6', reportCategory: 'item', type: 'found', item: 'Samsonite Suitcase', description: 'A large blue hard-shell suitcase.', date: '2024-07-20', status: 'resolved', resolvedDate: '2024-07-22', location: 'Nanakheda Bus Stand', coords: { lat: 23.1973, lng: 75.7944 }, imageUrl: 'https://images.unsplash.com/photo-1581553983792-c138b254d036?q=80&w=400' },
    { id: 'rep11', reporterId: 'u7', reportCategory: 'item', type: 'lost', item: 'Airpods Pro', description: 'Apple Airpods Pro in a white case.', date: '2024-07-21', status: 'pending', location: 'Mahakaleshwar Temple', coords: { lat: 23.1863, lng: 75.7663 }, imageUrl: 'https://images.unsplash.com/photo-1608043148419-916576624328?q=80&w=400' },
    { id: 'rep12', reporterId: 'u10', reportCategory: 'item', type: 'found', item: 'Toddler\'s Shoe', description: 'A single small pink shoe for a toddler.', date: '2024-07-20', status: 'closed', location: 'Ram Ghat, Ujjain', coords: { lat: 23.1812, lng: 75.7682 }, imageUrl: 'https://images.unsplash.com/photo-1515757393165-8b38072a2e37?q=80&w=400' },
    { id: 'rep13', reporterId: 'u1', reportCategory: 'item', type: 'lost', item: 'College ID Card', description: 'ID card for Avantika University for a student named Neha Sharma.', date: '2024-07-18', status: 'resolved', resolvedDate: '2024-07-19', location: 'Food court area', coords: { lat: 23.1768, lng: 75.7888 }, imageUrl: 'https://images.unsplash.com/photo-1620336234384-f772a510a751?q=80&w=400' },
    { id: 'rep14', reporterId: 'u4', reportCategory: 'item', type: 'found', item: 'Water Bottle', description: 'A steel water bottle with "Stay Hydrated" written on it.', date: '2024-07-18', status: 'in_review', location: 'Parking Lot B', coords: { lat: 23.1752, lng: 75.7852 }, imageUrl: 'https://images.unsplash.com/photo-1602143407151-2474f4b6d760?q=80&w=400' },
    { id: 'rep15', reporterId: 'u5', reportCategory: 'item', type: 'lost', item: 'Small Gold Earring', description: 'A single small gold earring with a floral design. Very sentimental value.', date: '2024-07-25', status: 'pending', location: 'Harsiddhi Temple', coords: { lat: 23.1839, lng: 75.7663 }, imageUrl: 'https://images.unsplash.com/photo-1611652033933-8c2328582103?q=80&w=400' },
    { id: 'rep16', reporterId: 'u7', reportCategory: 'item', type: 'lost', item: 'Aadhar Card', description: 'My Aadhar card, name is Prakash Mehra. It was in a plastic sleeve.', date: '2024-07-26', status: 'pending', location: 'Ujjain Railway Station', coords: { lat: 23.1758, lng: 75.7738 }, imageUrl: 'https://images.unsplash.com/photo-1556740738-b6a63e27c4df?q=80&w=400' }
];
...
export const mockVolunteerTasks = [
    ...
    { id: 'task3', title: 'Deliver Found Item', description: 'Deliver a found wallet (Report #rep4) to the central evidence room.', location: 'Central Evidence Room', status: 'completed' },
    { id: 'task4', title: 'Investigate Sighting', description: 'Proceed to CAM 04 - Ram Ghat to verify a potential sighting of missing person Mahesh Kumar (Report #rep-p1).', location: 'CAM 04 - Ram Ghat', status: 'pending' },
];
