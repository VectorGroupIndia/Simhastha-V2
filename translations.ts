export const uiStrings = {
  English: {
    ...
    reportCategoryTitle: "What are you reporting?",
    reportCategoryItem: "An Item",
    reportCategoryPerson: "A Person",
    reportTypeLost: "Lost / Missing",
    reportTypeFound: "Found",
    uploadAndAnalyze: "Upload a Photo & Use AI",
    chooseImage: "Click to upload",
    ...
    analysisMultiItemTitle: "Multiple Items Detected",
    analysisMultiItemBody: "Our AI found several items in your photo. Please select the one you want to report now. You can file reports for the others later.",
    analysisFaceSelectionTitle: "Multiple Faces Detected",
    analysisFaceSelectionBody: "Please select the face of the person you wish to report.",
