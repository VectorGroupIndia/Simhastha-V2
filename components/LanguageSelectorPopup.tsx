...
const LanguageSelectorPopup: React.FC<LanguageSelectorPopupProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-95 hover:scale-100 border border-white/20 text-white">
        <div className="p-6 md:p-8 text-center">
          ...
          <p className="text-slate-300 mb-6 font-semibold">continue with / जारी रखें</p>
          ...
          <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                  <span className="px-2 bg-brand-glass-bg/0 text-sm text-gray-400">OR</span>
              </div>
          </div>

          <button onClick={onClose} className="w-full px-6 py-3 border border-brand-secondary text-brand-secondary rounded-lg hover:bg-brand-secondary hover:text-white transition-colors bg-brand-secondary/10">
